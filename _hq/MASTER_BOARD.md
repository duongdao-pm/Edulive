...
| EDU002-PM-001 | EDU-002 | [ALO Ngoc] Cap nhat lich lam viec va trien khai sang cho Nexta — gui cho anh Ngoc | pm | — | HIGH | PENDING | — |
| — | EDU-001 | Phan tich luong Assignment (Lop hoc sau bai giang) — FE va Tech Lead hieu lech | ba | — | HIGH | PENDING | — |
| — | EDU-001 | Document Quy trinh Approval bai giang theo tung version | ba | — | MEDIUM | PENDING | — |
| — | EDU-001 | Viet User Stories cho Offline use cases (GV tao lop, giao bai, day — khong internet) | ba | — | MEDIUM | PENDING | — |
...
| Task ID | Project | Task | Team | Status | Completed |
|:--------|:--------|:-----|:-----|:-------|:----------|
| EDU002-QC-001 | EDU-002 | QC test xong 70 thiet bi | qc | DONE | 2026-02-27 |
| EDU002-BE-001 | EDU-002 | Ban cai Nexta (B2B Offline): dong goi + kiem thu chay hoan thien | be | DONE | 2026-02-27 |
| — | EDU-001 | Ban cai Hoi Hop B: da cai va hoat dong, test 1 ngay | be | DONE | 2026-02-27 |
| EDU000-PM-003 | Cross-project | Cap nhat Google Sheet Daily Task — toan bo cong viec va du an tuan 24/02-28/02 | pm | DONE | 2026-02-27 |
| EDU000-PM-004 | Cross-project | Viet bao cao tuan gui Sep TA (TGD) — tuan 24/02-28/02 | pm | DONE | 2026-02-27 |
| — | EDU-001 | BAO CAO — Status tablet Hoi Hop B (tu QC Linh): 74/75 OK | qc | DONE | 2026-02-27 |
| — | N/A | THONG BAO — Loi mat nut dang nhap man hinh Social da duoc xu ly | fe, qc | DONE | 2026-02-27 |
| — | EDU-002 | KHAN — Chuan bi Demo noi bo Phong hoc thong minh ngay mai (27/02) | all | DONE | 2026-02-27 |
| EDU001-FE-002 | EDU-001 | [ALO Ngoc] Clarify API Search — Bug da xu ly xong | fe, be | DONE | 2026-02-27 |
| EDU002-PM-002 | EDU-002 | [ALO Ngoc] Cap nhat va gui bao cao tuan cho anh Ngoc (Tech Lead) | pm | DONE | 2026-02-27 |
| — | EDU-001 | Viet testcase bo sung cho SmartRoom — cac module CHUA CO test coverage | qc | DONE | 2026-02-24 |

---

## Bug Tracker (from QC)

| Bug ID | Project | Description | Module | Status | Reported |
|:-------|:--------|:------------|:-------|:-------|:---------|
| — | EDU-002 | GV tat video nhung video van phat | Audio/Video | FIXED | 2026-02-27 |
| — | EDU-002 | Audio trang 3 khong phat khi pause trang 2 roi next | Audio | FIXED | 2026-02-27 |
| — | EDU-002 | GV assign content lan dau → HS mat nut Submit | Assignment | FIXED | 2026-02-27 |
| — | EDU-002 | HS lam dung nhung GV hien thi thanh trang thai bao sai — phieu bai tap tuong tac | Thong ke GV | FIXED | 2026-02-27 |
| — | EDU-002 | STEM tich hop: GV assign → HS mat 1 binh nuoc | STEM | FIXED | 2026-02-27 |
| EDU002-BUG-002 | EDU-002 | Thong ke exercise tren web: HS vao sau assign → chua hien. Khong co thong ke bai lam tren tablet | Thong ke | INVESTIGATING | 2026-02-27 |

---

## Status Legend
- `PENDING` — Cho dispatch
- `ASSIGNED` — Da dispatch, agent chua bat dau
- `IN_PROGRESS` — Agent dang lam
- `REVIEW` — Cho review (PM/Head)
- `DONE` — Hoan thanh
- `BLOCKED` — Bi chan (xem ESCALATION_LOG)

## Team Legend
- `pm` | `ba` | `dev_be` | `dev_fe` | `qc` | `ai` | `sync`

## Model Legend
- `opus` | `sonnet` | `gemini_pro` | `gemini_flash` | `cursor` | `haiku`

## Project Legend
- `EDU-001` — Hoi Hop B / Vinh Phuc Deployment (B2C Legacy)
- `EDU-002` — Nexta B2B Offline (Native Image)
- `EDU-003` — AI Tools & Content Pipeline
